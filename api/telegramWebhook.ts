...
const TELEGRAM_TOKEN = (process.env.VITE_TELEGRAM_BOT_TOKEN as string) || (import.meta as unknown as Record<string, Record<string, string>>).env?.VITE_TELEGRAM_BOT_TOKEN;
